const translations = {
	"DE": {
		...
		"stress-points": "Stresspunkte",
		"stress-points-tooltip": "Stresspunkte stellen die Widerstandsfähigkeit deines Charakters dar. Schlägt eine Probe fehl, so verlierst du einen Stresspunkt. Hast du keine freien Punkte mehr, erleidest du beim nächsten Mal statt Stress einen Nachteil.",
		"ailment": "Nachteile",
		"ailment-tooltip": "Ein Nachteil stellt eine Beeinträchtigung deines Charakters dar. Hat dein einen Nachteil, der eine Probe negativ beeinflusst, so wird sein Würfelpool für diese halbiert (aufgerundet)",
		"class": "Klassen",
		"class-tooltip": "Klassen beschreiben größere Themengebiete, in denen dein Charakter gelernt ist. Es kann ein Beruf, eine magische Veranlagung, ein technisches Implantat, etc. sein. Um eine Klasse auf Level 3 zu bringen muss der Charakter zuerst 30 AP in Fertigkeiten investiert haben. Für Level 4 sind es mindestens 40 AP.",
		"stress-abbrev": "SP",
		"class-name": "Name",
		"class-level": "Level",
		...
		"money": "Geld",
		"adventure-points-abbrev": "AP",
		"adventure-points-tooltip": "Abenteuer Punkte (AP) können benutzt werden, um Fertigkeiten, Klassen oder auch Items zu kaufen und zu verbessern.",
		"good-rations": "Gute Verpflegung",
		"good-rations-tooltip": "Während einer Rast kannst du 2 SP deines Charakters oder 4 SP verteilt auf Klassen und Fertigkeiten verteilt wiederherstellen.",
	...
	"EN": {
		...
		"stress-points-tooltip": "Stress points represent your characters resilience. If a check fails, you lose a stress point. If you don't have any points left, the next time you would normally lose a stress point you will suffer a disadvantage instead.",
		"ailment": "Ailments",
		"ailment-tooltip": "An ailment represents a disadvantage to your character. If you have an ailment that negatively affects a check, your dice pool for this check is halved (rounded up).",
		"class": "Classes",
		"class-tooltip": "Classes describe larger subject areas in which your character is trained. It can be a profession, a magical predisposition, a technical implant, etc. To bring a class to level 3, the character must first have invested 30 AP in their skills. For level 4 they need at least 40 AP.",
		"stress-abbrev": "SP",
		"class-name": "Name",
		"class-level": "Level",
		"equipment": "Equipment",
		...
		"money": "Money",
		"adventure-points-abbrev": "AP",
		"adventure-points-tooltip": "Adventure Points (AP) can be used to purchase and improve skills, classes or even items.",
		"good-rations": "Good Rations",
		"good-rations-tooltip": "While resting you can restore<br>2 SP of your character or 4 SP<br>across your classes and abilities.",
		"abilities": "Abilities",
